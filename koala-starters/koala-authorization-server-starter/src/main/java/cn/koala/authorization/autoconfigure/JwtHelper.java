...
public abstract class JwtHelper {
  ...
  public static RSAKey generateRsa(String keyID, String publicKey, String privateKey)
    ...
    KeyPair keyPair = generateRSAKey(publicKey, privateKey);
  ...
  public static KeyPair generateRSAKey(String publicKey, String privateKey) throws NoSuchAlgorithmException,
