...
public interface PermissionApi {
  ...
  @Parameter(in = ParameterIn.QUERY, name = "权限名称", description = "权限名称", schema = @Schema(type = "string"))
   ...
   * @return 权限
   */
  @Operation(summary = "创建权限", tags = {"permission"})
  @ApiResponse(responseCode = "200", description = "成功",
    content = {@Content(mediaType = "application/json", schema = @Schema(implementation = PermissionResult.class))}
  )
  @PostMapping
   ...
   * @return 操作结果
   */
  @Operation(summary = "更新权限", tags = {"permission"})
  @ApiResponse(responseCode = "200", description = "成功",
   ...
   * @return 操作结果
   */
  @Operation(summary = "删除权限", tags = {"permission"})
  @ApiResponse(responseCode = "200", description = "成功",
    content = {@Content(mediaType = "application/json", schema = @Schema(implementation = Response.class))}
  )
  @Parameter(in = ParameterIn.PATH, name = "id", description = "权限id", schema = @Schema(type = "string"))
  ...
  class PermissionPageResult extends DataResponse<Page<Permission>> {

  }

  class PermissionResult extends DataResponse<Permission> {
