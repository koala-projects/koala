package cn.houtaroy.koala.component.dingtalk;
...
public class InMemoryDingtalkService implements DingtalkService {
  ...
  private final Map<String, DefaultDingTalkClient> oldClients = new ConcurrentHashMap<>(MapConstant.DEFAULT_SIZE);
  private final Map<Class<? extends Client>, Client> newClients = new ConcurrentHashMap<>(MapConstant.DEFAULT_SIZE);
